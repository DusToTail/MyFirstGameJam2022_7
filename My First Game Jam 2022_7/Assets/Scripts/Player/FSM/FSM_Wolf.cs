...
public class FSM_Wolf : FiniteStateMachine
{
    ...
    private void Initialization()
    {
        ...
        states = new List<State>()
        {
            ...
            new S_Idle<WolfBehaviour>(this), // 1
            new S_Aggressive(this), // 2
            new S_Chase<WolfBehaviour>(this), // 3
            new S_Attack<WolfBehaviour>(this), // 4
            new S_Idle<WolfBehaviour>(this) // 5
        };
        ...
        var _IfCanAttack = new TN_CanAttack<WolfBehaviour>(this);
        var _IfCanNotAttack = new TN_CanAttack<WolfBehaviour>(this, true);
